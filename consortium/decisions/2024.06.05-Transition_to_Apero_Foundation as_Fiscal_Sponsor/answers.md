...
Currently, we have no other contractual obligations. Some expenses for various online services utilized within the Dat ecosystem are subsidized by select Dat projects. Periodically, funds received by the Dat ecosystem are allocated to reimburse these projects.
...
No, the consortium and it's members and all dat ecosystem member projects will stay unchanged.
...
The project primarily relies on donations from Open Collective Members and occasional cryptocurrency contributions as its main sources of revenue. While the consortium of volunteers may explore the possibility of applying for grants in the future, it's important to acknowledge that such endeavors require considerable time and entail uncertain outcomes.
...
Notably, our operations do not necessitate any cloud or server instances.
...
1. What fees does Apero Foundation expect from it's member projects?

2. Can we continue operating through Open Collective?

3. What traditional and potentially crypto currencies does Apero Foundation support?
